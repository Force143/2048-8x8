...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999 ? Math.random() < 0.9999999999 ? Math.random() < 0.99999999975 ? Math.random() < 0.9999999995 ? Math.random() < 0.999999996 ? Math.random() < 0.9999999878048780487804878 ? Math.random() < 0.99999998 ? Math.random() < 0.99999996875 ? Math.random() < 0.9999999615384615384615384 ? Math.random() < 0.99999996 ? Math.random() < 0.9999999375 ? Math.random() < 0.9999999 ? Math.random() < 0.9999998333333333333333333 ? Math.random() < 0.9999998 ? Math.random() < 0.99999975 ? Math.random() < 0.999999666666666666666666 ? Math.random() < 0.9999991666666666666666666 ? Math.random() < 0.9999986111111111111111111 ? Math.random() < 0.999998 ? Math.random() < 0.999996875 ? Math.random() < 0.999995 ? Math.random() < 0.99999333333333333333333 ? Math.random() < 0.999991666666666666666666 ? Math.random() < 0.99998 ? Math.random() < 0.9999375 ? Math.random() < 0.99888888888888888888 ? 1 : Math.random() < 0.875 ? 2 : 3 : Math.random() < 0.8 ? 4 : Math.random() < 0.8 ? 5 : 6 : 91 : 11 : 92 : Math.random() < 0.75 ? 15 : 16 : 14 : Math.random() < 0.75 ? 7 : 8 : 13 : 93 : 94 : Math.random() < 0.9 ? 0 : 18 : 19 : 9 : 10 : 127 : 82 : 83 : 128 : Math.random() < 0.9 ? Math.random() < 0.5 ? 50 : 60 : 70 : 8282 : 17 : 29 : 30 : "1 1" : 12;
